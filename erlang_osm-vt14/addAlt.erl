...
start(Aa,Bb,Base,Split,Specc,Sleep) ->
    ...
    La=utilsAlt:intlist(A),
    Lb=utilsAlt:intlist(B),
    {ListA, ListB} = utilsAlt:fulfill(La,Lb),
    ...
    if
        ...
        true ->
            ...
            SplitA=utilsAlt:split(ListA,Split),
            SplitB=utilsAlt:split(ListB,Split),
            Tmp = (utilsAlt:getSum(SplitA,SplitB,Specc,Sleep)),
            Tmp2 = utilsAlt:list_to_int(Tmp),
